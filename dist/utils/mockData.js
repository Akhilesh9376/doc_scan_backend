export function generateMockSummary(fileName) {
    const summaries = [
...
export function generateMockInsights(fileName) {
    return [
        {
            id: "insight-1",
            title: "Revenue Growth Opportunity",
            description: "Identified 23% potential revenue increase through market expansion",
            priority: "high",
            category: "financial",
            relevanceScore: 0.95,
        },
        {
            ...
            description: "Process optimization can reduce operational costs by 15-20%",
            priority: "high",
