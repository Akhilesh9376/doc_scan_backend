...
import { chatMessagesMap, documentsMap, fileBuffersMap, } from "../utils/memoryStore.js";
...
export const handleGetChatMessages = async (req, res) => {
...
export const handleSendChatMessage = async (req, res) => {
    ...
    try {
        ...
        if (isMongoConnected()) {
            try {
                await ChatMessageModel.findOneAndUpdate({ documentId }, {
                    $setOnInsert: {
                        documentId,
