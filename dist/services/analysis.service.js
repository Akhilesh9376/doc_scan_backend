...
export async function generateAISummaryFromBuffer(buffer, mimeType, fileName) {
    ...
    const geminiFile = await uploadDocumentBufferToGemini(buffer, mimeType, fileName);
    const contents = [
        createUserContent([
...
export async function generateAIInsightsFromBuffer(buffer, mimeType, fileName) {
